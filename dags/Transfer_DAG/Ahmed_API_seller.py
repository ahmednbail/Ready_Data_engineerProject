...
GCS_PREFIX = "ready-labs-postgres-to-gcs/ahmednabil/api/sellers"   # path inside bucket
API_URL = "https://sellers-table-834721874829.europe-west1.run.app"
BIGQUERY_DATASET = "ready-de26.project_landing"
BQ_TABLE = "sellers_ahmednabil"
LOCAL_TMP_DIR = "/tmp"
...
# -------------------- DAG --------------------
with DAG(
    dag_id="ahmednabil_seller_api_dag",
    schedule_interval=None,
    start_date=datetime(2025, 8, 25),
    catchup=False,
    tags=["api", "ahmednabil", "gcs-to-bq"],
) as dag:
